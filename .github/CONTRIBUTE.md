...
```bash
$ git clone git@github.com:finalgene/docker-hub-phpmd.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-phpmd.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-phpmd)
...
```bash
$ git remote add {username} git@github.com:{username}/docker-hub-phpmd.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-phpmd.git
